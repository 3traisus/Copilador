...
public class Definitivo
{
	...
	private boolean Excepciones(String cad)
	{
		...
		//Aqui vas a poner el estado de produccion de donde termina 
		//Termina asignacion
		if(pilaT.getLast().equals("I21"))//
		{
			banAsig = false;
		...
		//Empieza asignacion
		if(pilaT.getLast().equals("I07") || banAsig)//Aqui vas a poner el estado que comienza la asignacion 
	...
	public static void main(String[] args)
	{
        ...
        //obp.Accion(obp.Entrada(obp.Separar("float var , var2 , var3  ; var =  var2 * var + var3 / 5 ;")));
            
		obp.Accion(obp.Entrada(obp.Separar("float var , var2 , var3  ; var =   ( var2  +  var )  + var3 / 5 ;")));
  
		//obp.Accion(obp.Entrada(obp.Separar("int var , var2 , var3  ; var =   ( var2  +  var ) * var3 - 5 ;")));
		//obp.Accion(obp.Entrada(obp.Separar("int var , var2 , var3  ;  var =  ( ( var2  *  var ) + ( var2  *  var ) ) ;")));
		//obp.Accion(obp.Entrada(obp.Separar("int var , var2 , var3  ; var3 = var + var2 - var * 8 + 5 * var ;")));
		
		//obp.Accion(obp.Entrada(obp.Separar("int var , var2 , var3  ; var =  var2 * var + var3 ;")));
		
		//obp.Accion(obp.Entrada(obp.Separar("int var , var2  ; var =  var2 - var * 8 ;")));
